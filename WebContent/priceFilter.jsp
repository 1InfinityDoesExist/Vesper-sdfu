...
<body bgcolor="#f8f88">
	...
	<%
		...
		String pn = (String) request.getAttribute("proname");
		ResultSet rs = stmt
				.executeQuery("select *from customer where pname = '" + pn
						+ "' ");
	%>
	...
	<div class="container">
		<center>
			...
			<h1>This One Is For Product Based Filter</h1>
			<table class="table table-dark">
				<thead>
					<tr>
						<th scope="col">InvoiceNumber
						</td>
						<th scope="col">ProductName
						</td>
						<th scope="col">ProductSerialNo
						</td>
						<th scope="col">Quantities
						</td>
						<th scope="col">PricePerPro
						</td>
						<th scope="col">TotalPrice
						</td>
						<th scope="col">SaleDate
						</td>
					</tr>
				</thead>
				<%
