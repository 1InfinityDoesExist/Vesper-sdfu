...
<BODY onload="noBack();" onpageshow="if (event.persisted) noBack();"
 ...
 %> <%!Connection con = null;
	...
	public void jspDestroy() {
 	...
 	String f1 = (String) request.getAttribute("from");
 	String f2 = (String) request.getAttribute("to");
 	ResultSet rs = stmt
 			.executeQuery("select *from customer where date between '"
 					+ f1 + "' and '" + f2 + "' ");
 %>
	...
	<center>
		<div class="container">
			...
			<h1>This One Is For Year Based Filter</h1>
